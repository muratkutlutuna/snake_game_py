...
SEPARATION = 10     # seperation between two pixels
SCREEN_HEIGHT = 600
SCREEN_WIDTH = 800
FPS = 25
...
# to check the boundries here we are not limitin boundries like it can pass through screen and come from other side
...
def main():
    ...
    mySnake.move()
    start_segments = 3 # inititally we will be having 3 segment long snake
